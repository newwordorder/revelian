...
<div class="col-md-6 col-lg-4 product-flex">
    ...
    <div class="blog-tile ">
        <a href="<?php the_permalink(); ?>" <?php if($category == 'media'): ?>target="_blank" <?php endif; ?>
            class="blog-tile__tile-link">
        </a>
        <div class="blog-tile__thumb">
            ...
            <?php if( $category ): ?>
            <div class="icon"
                style="position:absolute; height: 1em; width: 1em; bottom:0; left: 0; background-color:white; display:flex; flex-direction: row; align-items: center; justify-content: center;">
                <?php if($category == "white-papers"): ?>
                <i class="fas fa-file" style="font-size:0.5em; color:#ef0d33;"></i>
                <?php endif; ?>
                <?php if($category == 'case-studies'): ?>
                <i class="fas fa-book-open" style="font-size:0.5em; color:#ef0d33;"></i>
                <?php endif; ?>
                ...
                <i class="fas fa-newspaper" style="font-size:0.5em; color:#ef0d33"></i>
                <?php endif; ?>
            </div>
            <?php endif; ?>
        ...
        <div class="blog-tile__content">
            ...
            <?php endif; ?>
            <a class="btn" <?php if($category == 'media'): ?>target="_blank" <?php endif; ?>
