...
function () {
  ...
  _createClass(testsBox, [{
      ...
      var buttons = function buttons() {
        if (_this.getNumberOfPages() != 1) {
          if (_this.getActivePage() === 0) {
            return "<li class=\"page-item\"><a class=\"page-link page-link--nonlink\">Page ".concat(_this.getActivePage() + 1, " of ").concat(_this.getNumberOfPages(), "</a></li><li id=\"pageNo--").concat(nextPage, "\" class=\"page-item\"><a class=\"page-link\">Next</a></li>");
          } else if (_this.getActivePage() === _this.chunkArray(_this.mapped, 20).length - 1) {
            return "<li id=\"pageNo--".concat(previousPage, "\" class=\"page-item\"><a class=\"page-link\">Previous</a></li><li class=\"page-item\"><a class=\"page-link page-link--nonlink\">Page ").concat(_this.getActivePage() + 1, " of ").concat(_this.getNumberOfPages(), "</a></li>");
          } else {
            return "<li id=\"pageNo--".concat(previousPage, "\" class=\"page-item\"><a class=\"page-link\">Previous</a></li><li class=\"page-item\"><a class=\"page-link page-link--nonlink\">Page ").concat(_this.getActivePage() + 1, " of ").concat(_this.getNumberOfPages(), "</a></li><li id=\"pageNo--").concat(nextPage, "\" class=\"page-item\"><a class=\"page-link\">Next</a></li>");
          }
        } else {
          return "";
        }
      ...
      var buttons = function buttons() {
        if (_this2.getNumberOfPages() != 1) {
          if (_this2.getActivePage() === 0) {
            return "<li class=\"page-item\"><a class=\"page-link page-link--nonlink\">Page ".concat(_this2.getActivePage() + 1, " of ").concat(_this2.getNumberOfPages(), "</a></li><li id=\"pageNo--").concat(nextPage, "\" class=\"page-item\"><a class=\"page-link\">Next</a></li>");
          } else if (_this2.getActivePage() === _this2.chunkArray(_this2.mapped, 20).length - 1) {
            return "<li id=\"pageNo--".concat(previousPage, "\" class=\"page-item\"><a class=\"page-link\">Previous</a></li><li class=\"page-item\"><a class=\"page-link page-link--nonlink\">Page ").concat(_this2.getActivePage() + 1, " of ").concat(_this2.getNumberOfPages(), "</a></li>");
          } else {
            return "<li id=\"pageNo--".concat(previousPage, "\" class=\"page-item\"><a class=\"page-link\">Previous</a></li><li class=\"page-item\"><a class=\"page-link page-link--nonlink\">Page ").concat(_this2.getActivePage() + 1, " of ").concat(_this2.getNumberOfPages(), "</a></li><li id=\"pageNo--").concat(nextPage, "\" class=\"page-item\"><a class=\"page-link\">Next</a></li>");
          }
        } else {
          return "";
        }
    ...
    value: function reset() {
      ...
      var newList = this.categoryFilter(category.value);
    ...
    key: "copySetup",
    value: function copySetup() {
      var _this8 = this;

      var buttons = document.querySelectorAll(".copybtn");
      buttons.forEach(function (button) {
        return button.addEventListener("click", function () {
          _this8.copyToClipboard(button.dataset.content);
