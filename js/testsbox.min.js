...
function () {
  ...
  _createClass(testsBox, [{
    ...
    value: function paginationSetup(data) {
      ...
      var buttons = function buttons() {
        if (_this.getActivePage() === 0) {
          return "<li id=\"pageNo--".concat(nextPage, "\" class=\"page-item\"><a class=\"page-link\">Next</a></li>");
        } else if (_this.getActivePage() === _this.chunkArray(_this.mapped, 20).length - 1) {
          return "<li id=\"pageNo--".concat(previousPage, "\" class=\"page-item\"><a class=\"page-link\">Previous</a></li>");
        } else {
          return "<li id=\"pageNo--".concat(previousPage, "\" class=\"page-item\"><a class=\"page-link\">Previous</a></li><li id=\"pageNo--").concat(nextPage, "\" class=\"page-item\"><a class=\"page-link\">Next</a></li>");
        }
      };
    ...
    value: function prepareData(data) {
      ...
      return Object.values(data).map(function (a, index) {
    ...
    value: function mapData(data, index) {
      return "<div class=\"card my-2\">\n       <div class=\"card-header\" id=\"heading".concat(index, "\">\n         <h5 class=\"mb-0\">\n            <button class=\"btn btn-link\" type=\"button\" data-toggle=\"collapse\" data-target=\"#collapse").concat(index, "\" aria-expanded=\"false\" aria-controls=\"collapse").concat(index, "\">\n               ").concat(data.title, "\n             </button>\n         </h5>\n         <div class=\"d-flex row align-items-center justify-content-between\">\n         <h6 class=\"category mb-0 px-2\">").concat(data.category, "</h6>\n         <h6 class=\"mb-0 px-2\"><i class=\"far fa-clock\"></i><span style=\"font-weight:bold;\" class=\"px-2\">").concat(data.completeTime, "</span></h6>\n         <h6 class=\"mb-0 px-2\"><i class=\"fas fa-hashtag\"></i><span style=\"font-weight:bold;\" class=\"px-2\">").concat(data.questions, "</span></h6>\n         </div>\n       </div>\n       <div id=\"collapse").concat(index, "\" class=\"collapse\" aria-labelledby=\"heading").concat(index, "\" data-parent=\"#accordionExample\">\n         <div class=\"card-body\">\n            <div class=\"d-flex row align-items-center justify-content-between p-2\">\n              <p class=\"mb-0 px-2\"><b>Time to Complete: </b>").concat(data.completeTime, "</span></p>\n              <p class=\"mb-0 px-2\"><b>Number of Questions: </b><span class=\"px-2\">").concat(data.questions, "</span></p>\n              <p class=\"mb-0 px-2\"><b>Language: </b>").concat(data.us, "</p>\n            </div> \n            <p class=\"description\"><b>Description: </b><br />").concat(data.description, "</p>\n            </div>\n         </div>\n       </div>\n   ");
    }
  }, {
    key: "isMultiPage",
    ...
    value: function selectorSetup() {
      ...
      var categories_all = this.data.map(function (a) {
        return a.category;
      });
